...
const Paragraph: React.FC<ParagraphProps> = ({ videoSource, sentence }) => {
  ...
  return (
    <div className="z-10 items-center justify-between w-full max-w-5xl font-mono text-sm text-white/90 lg:flex">
      <div className="mt-5 d-flex flex-col h-100 text-white/90">
        <audio ref={audioRef} controls key={videoSource}>
        ...
        <p className="mt-5 mb-5 text-center text-2xl text-white sm:text-left">{parse(sentence)}</p>
